...
module SwaggerClient
  class FaxApi
    ...
    def fax_document_id_costs_get_with_http_info(api_key, fax_number, document_id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'api_key' when calling FaxApi.fax_document_id_costs_get" if api_key.nil?
      # verify the required parameter 'fax_number' is set
      fail ArgumentError, "Missing the required parameter 'fax_number' when calling FaxApi.fax_document_id_costs_get" if fax_number.nil?
      # verify the required parameter 'document_id' is set
      fail ArgumentError, "Missing the required parameter 'document_id' when calling FaxApi.fax_document_id_costs_get" if document_id.nil?
      # resource path
      local_var_path = "/fax/{document_id}/costs".sub('{format}','json').sub('{' + 'document_id' + '}', document_id.to_s)
    ...
    def fax_job_id_status_get_with_http_info(api_key, job_id, opts = {})
      ...
      # verify the required parameter 'api_key' is set
      fail ArgumentError, "Missing the required parameter 'api_key' when calling FaxApi.fax_job_id_status_get" if api_key.nil?
      # verify the required parameter 'job_id' is set
      fail ArgumentError, "Missing the required parameter 'job_id' when calling FaxApi.fax_job_id_status_get" if job_id.nil?
      # resource path
      local_var_path = "/fax/{job_id}/status".sub('{format}','json').sub('{' + 'job_id' + '}', job_id.to_s)
